...
<body class="min-h-screen" x-data="app()" x-init="init()" x-cloak>
      ...
      <template x-for="device in config?.devices" :key="device.name">
        <div class="glass-card rounded-2xl overflow-hidden"
          ...
          <div class="px-5 py-4" style="border-bottom:1px solid rgba(255,255,255,0.06)">
              ...
              <div class="flex items-center gap-2.5 min-w-0">
                <div class="flex flex-col items-center flex-shrink-0">
                  <div class="w-7 h-7 rounded-lg flex items-center justify-center"
                    ...
                    <span x-html="icon(device.type === 'ulanzi' ? 'tv' : 'monitor', 14, device.type === 'ulanzi' ? 'color:#f59e0b' : 'color:#22d3ee')" style="display:flex"></span>
                  </div>
                ...
                <div class="min-w-0">
                  <div class="font-semibold text-white leading-tight" x-text="deviceTitle(device)"></div>
                  <div class="text-[11px] font-mono mt-0.5" style="color:rgba(255,255,255,0.3)" x-text="device.name"></div>
                </div>
              </div>
            ...
            <div class="h-8 flex items-start overflow-hidden">
              <div class="text-[11px] leading-snug" style="color:rgba(255,255,255,0.3);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden"
  ...
  <div x-show="showSceneSettings" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center p-4"
    ...
    <div class="glass-card rounded-2xl w-full max-w-5xl max-h-[92vh] p-6 flex flex-col gap-5 overflow-hidden">
      ...
      <div class="overflow-y-auto pr-1 flex flex-col gap-5" style="overscroll-behavior:contain" @input.debounce.300ms="_scheduleAutoOverlay()" @change="_scheduleAutoOverlay()">
