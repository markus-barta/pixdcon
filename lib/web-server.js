...
<body class="min-h-screen" x-data="app()" x-init="init()" x-cloak>
  ...
  <script>
    const ICON_PATHS = {
      ...
      'settings':        '<path d="M12.22 2h-.44a2 2 0 0 0-1.94 1.53l-.24.95a2 2 0 0 1-2.83 1.29l-.85-.49a2 2 0 0 0-2.52.32l-.31.31a2 2 0 0 0-.32 2.52l.49.85A2 2 0 0 1 4.52 12l-.95.24A2 2 0 0 0 2 14.16v.44a2 2 0 0 0 1.53 1.94l.95.24a2 2 0 0 1 1.29 2.83l-.49.85a2 2 0 0 0 .32 2.52l.31.31a2 2 0 0 0 2.52.32l.85-.49a2 2 0 0 1 2.83 1.29l.24.95A2 2 0 0 0 11.78 22h.44a2 2 0 0 0 1.94-1.53l.24-.95a2 2 0 0 1 2.83-1.29l.85.49a2 2 0 0 0 2.52-.32l.31-.31a2 2 0 0 0 .32-2.52l-.49-.85a2 2 0 0 1 1.29-2.83l.95-.24A2 2 0 0 0 22 14.6v-.44a2 2 0 0 0-1.53-1.94l-.95-.24a2 2 0 0 1-1.29-2.83l.49-.85a2 2 0 0 0-.32-2.52l-.31-.31a2 2 0 0 0-2.52-.32l-.85.49a2 2 0 0 1-2.83-1.29l-.24-.95A2 2 0 0 0 12.22 2Z"/><circle cx="12" cy="12" r="3"/>',
    };
