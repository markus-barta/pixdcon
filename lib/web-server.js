    ...
    try {
      ...
      if (method === "GET" && url.pathname === "/api/status") {
        ...
        for (const { device, loop } of this.getRenderLoops()) {
          ...
          // Health: circuit open (>=10 consecutive errors) = definitely offline.
          // Also surface "degraded" (errors but still trying) so the UI can
          // hint at trouble before the breaker pops.
            ...
            <ol class="mt-2 space-y-1.5 pl-4" style="list-style:decimal;color:rgba(255,255,255,0.8)">
              <li>
                ...
                <span class="font-mono px-1.5 py-0.5 rounded text-[11px]"
                  ...
                  x-text="deviceHealth[recoveryHelpDevice]?.apSsid || 'AWTRIX_<device-uid>'"></span>
